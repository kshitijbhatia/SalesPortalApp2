...
class AddNSM1Page extends StatefulWidget {
  const AddNSM1Page(
  ...
  @override
  State<AddNSM1Page> createState() => _AddNSM1PageState();
}

class _AddNSM1PageState extends State<AddNSM1Page> {
  @override
        ...
        children: [
          ...
          Column(
            children: [
              ...
              InputField(
                text: 'Enter NSM1 Contact Number *',
