        ...
        children: [
          ...
          if (widget.currentPage == 1)
            Container(
              ...
              child: Center(
                  child: Text(
                'Dealer Code : ${widget.dealerCode}',
                style: const TextStyle(
                    color: Colors.black, fontFamily: 'Roboto', fontSize: 28),
              )),
            ),
          const SizedBox(
            height: 20,
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return InputField(
                  ...
                  removeError: (){
                    setState(() {
                      widget.columnHeaders[index]['error'] = null;
                    });
                  },
                );
              },
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                for (var i = 0; i < widget.columnHeaders.length; i++) {
                  ...
                  if (column.contains('Dealer Name') ||
                    ...
                    for (var j = 0; j < widget.data.length; j++) {
                      ...
                      if (widget.data[j].DealerEmailAddress ==
                          widget.controllers[i].text) {
                        setState(() {
                          widget.columnHeaders[i]['error'] =
